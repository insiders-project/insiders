...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('scool', '0010_alter_scool_classes_class_published_in_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2023, 1, 21, 20, 32, 34, 859695)),
        ),
        migrations.AlterField(
            model_name='scool_lessons',
            name='lesson_published_in',
            field=models.DateTimeField(default=datetime.datetime(2023, 1, 21, 20, 32, 34, 875326)),
        ),
        migrations.AlterField(
